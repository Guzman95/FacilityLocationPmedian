/****** Object:  Table [dbo].[Tareas]    Script Date: 08/25/2016 10:56:25 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tareas](
	...
	[Tar_Algoritmo] [varchar](100) NOT NULL,
	[Tar_Parametros] [varchar](200) NOT NULL,
	[Tar_Semilla] [int] NOT NULL,
	[Tar_Estado] [varchar](1) NULL,
...
while @cnt < 31  begin
	insert into dbo.Tareas(Dt_Problem, Dt_Seed, Dt_Algorithm, Dt_Result_Best,Dt_Status)
	values
